...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_91_ansi(
        ...
        _______,  KC_LCTL,  KC_LWIN,  KC_LALT,  MO(MAC_FN),         KC_SPC,                        KC_SPC,             KC_RALT,  MO(MAC_FN), KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [NAV] = LAYOUT_91_ansi(
        ...
        _______,  KC_ESC,   _______,  _______,  _______,  _______,  _______,   KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  _______,  KC_GRV,                _______,            KC_END,
